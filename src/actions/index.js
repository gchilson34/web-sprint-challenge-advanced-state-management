...
export const GOT_SMURFS = "Got Smurfs";
...
export const fetchSmurfs = () => dispatch => {
    ...
    dispatch(gotSmurfs(name, position, nickname, description))
    })
}

export const gotSmurfs = (name, position, nickname, description) => {
    console.log(name);
    console.log(position);
    console.log(nickname);
    console.log(description);
    return {type: GOT_SMURFS, name, position, nickname, description}
}
